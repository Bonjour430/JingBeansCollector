...
class QMM(object):
    ...
    def _crawl_url(self):
        ...
        for link in bs.tbody.find_all('a'):
            ...
            print("获取 {} 的爬取地址：{}".format(text, qmm_detail))
            ...
            for body in bs.find_all('tbody'):
                for mall in body.find_all('a'):
                    ...
                    if 'shop.m.jd.com' in url or 'wqshop.jd.com/mshop/gethomepage' in url:
...
if __name__ == '__main__':
    qmm = QMM(sleep=3, months='2', days='1-28')
    qmm.start()